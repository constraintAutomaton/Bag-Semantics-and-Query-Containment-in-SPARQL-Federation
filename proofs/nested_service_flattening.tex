...
Let $P_a$ and $P_b$ be the \ac{BGP} of services $a$ and $b$ respectively.
The nested form corresponds to the following FedQPL expression, where we abuse notation by placing a FedQPL expression in the superscript of $\freq$ giving: $\freq_a^{\fmj(P_a, \freq_b^{P_b})}$
