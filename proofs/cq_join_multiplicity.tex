...
\begin{multline*}
\operatorname{multiplicity}(\mu \mid \operatorname{Join}(\Omega_1, \Omega_2)) = \\
\sum_{m(\mu)} \operatorname{multiplicity}(\mu_1 \mid \Omega_1) \times \operatorname{multiplicity}(\mu_2 \mid \Omega_2)
\end{multline*}
...
$\operatorname{multiplicity}(\mu_1 \mid \Omega_1) \times \allowbreak \operatorname{multiplicity}(\mu_2 \mid \Omega_2)$ exceeds one, or (ii) the index set $m(\mu)$ contains more than one pair.
