...
Evaluating a query over a federation $F$ involves decomposing $Q$ into subqueries $P_i$, where each subquery $P_i$ is evaluated on a knowledge graph $G \in \operatorname{codomain}(F)$ held by a federation member.
