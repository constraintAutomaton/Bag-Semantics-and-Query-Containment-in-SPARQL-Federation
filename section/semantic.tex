...
This gap has practical consequences, as it leaves the answers of federated queries under automatic source selection ambiguous, so that engines may return different answers to the same benchmark query~\cite{tam2026strengthening}.
