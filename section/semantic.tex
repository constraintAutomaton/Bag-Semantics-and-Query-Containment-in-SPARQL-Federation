...
It also leaves the duplication of a triple across federation members observable in the result bag, so that a query can determine how many members hold a given triple.
That information may serve domain purposes as well as integrity constraints over a federation.
